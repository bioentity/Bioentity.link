...
JATS.ARTICLE_LINK = ["inline-supplementary-material"].concat(
  JATS.RELATED_ARTICLE
);
JATS.ALL_PHRASE = JATS.ADDRESS_LINK.concat(JATS.ARTICLE_LINK)
  ...
  .concat(JATS.SUBSUP)
  .concat(JATS.X);
JATS.PARA_LEVEL = JATS.BLOCK_DISPLAY.concat(JATS.BLOCK_MATH)
  .concat(JATS.LIST)
